...
| Café supply bot (moved out) | [evergreen_supply_bot](https://github.com/kurotermoon-oss/evergreen_supply_bot), `docs/SUPPLY_BOT-MOVED.md` | No bot runtime/UI/worker remains here; legacy database definitions retained only to preserve existing data |
