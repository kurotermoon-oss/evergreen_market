...
Актуальная версия: `kurotermoon-oss/evergreen_market`, ветка `main` на GitHub. Локальный путь зависит от устройства. Читайте только справку по текущей задаче.

| Файл | Когда нужен |
| --- | --- |
| [AGENTS.md](../AGENTS.md) | Рабочие правила, команды и критерии объёма проверок |
| [DEVICE-WORKFLOW.md](DEVICE-WORKFLOW.md) | Работа с разных устройств, синхронизация GitHub и проверка публикации |
