...
export default function FloatingCartButton({
  ...
  return (
    <button
      ...
      title="Кошик"
      className={`eg-floating-cart eg-button group fixed z-[160] hidden h-[4.9rem] w-[4.9rem] items-center justify-center rounded-[1.55rem] border border-white/70 text-white shadow-2xl shadow-emerald-950/25 ring-4 ring-white/75 transition hover:-translate-y-1 lg:flex ${
        isOpen
